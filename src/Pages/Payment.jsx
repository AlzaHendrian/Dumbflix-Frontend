...
const Payment = () => {
  ...
  useEffect(() => {
    ...
    const myMidtransClientKey = import.meta.VITE_REACT_APP_MIDTRANS_CLIENT_KEY;
      ...
      <div className="px-8 py-24 container mx-auto h-[100vh]">
        ...
        <div className="flex gap-x-20 px-20 mt-10">
          ...
          <div className="w-1/3 flex flex-col justify-between bg-zinc-800 shadow-md rounded-md p-3">
            ...
            <button onClick={() => handleBuy.mutate({ price: 640000 })} className="bg-red-700 text-white mt-5 py-2 rounded-md">Buy plan</button>
          </div>
        </div>
      </div>
    </React.Fragment>
