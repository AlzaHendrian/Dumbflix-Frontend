	...
	<div className={`px-8 pt-3 pb-5 text-white`}>
		<div className="bg-zinc-900 p-3 rounded-md">
			...
			<form onSubmit={(e) => handleOnSubmit.mutate(e)}>
				...
				<div>
					<textarea onChange={handleOnChange} value={form.description} name="description" id="description" placeholder="Description" className="w-full rounded-md text-white bg-zinc-800 h-32 focus:ring-2 focus:ring-red-700 border-none"></textarea>
				</div>
